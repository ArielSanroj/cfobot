...
This server implements the MCP protocol for integration with Nanobot.
"""
...
class CFOBotMCPServer:
    ...
    def _analyze_financial_report(self, generate_visuals: bool, send_email: bool) -> Dict[str, Any]:
    ...
    def _get_budget_execution(self) -> Dict[str, Any]:
    ...
    def _upload_excel_report(self, file_path: str) -> Dict[str, Any]:
